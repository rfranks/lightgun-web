      ...
      >
        {Array.from({ length: MAX_AMMO }).map((_, i) => (
          <Box
            ...
            src={
              i < ammo
                ? withBasePath("/assets/fish/PNG/Objects/Fish/fish_green.png")
                : withBasePath(
                    "/assets/fish/PNG/Objects/Fish/fish_green_skeleton.png"
                  )
            }
            width={64}
            height={64}
      ...
      {duckCount > 0 && (
        ...
        >
          <Box
            component="img"
            src={withBasePath(
              "/assets/fish/PNG/Objects/Fish/fish_red_skeleton.png"
            )}
            width={48}
            height={48}
            sx={{ mr: 2 }}
